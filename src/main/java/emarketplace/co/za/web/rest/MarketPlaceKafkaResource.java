...
@RestController
@RequestMapping("/api/market-place-kafka")
public class MarketPlaceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MarketPlaceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MarketPlaceKafkaResource(KafkaProperties kafkaProperties) {
